...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.resetForm = this.fb.group({
      firstPassword: [null, [Validators.required, Validators.maxLength(9),Validators.minLength(20), this.customValidator.specialCharacter, this.customValidator.upperCase, this.customValidator.lowerCase, this.customValidator.oneNumber,Validators.pattern(/^((?!\s{1,}).)*$/)]],
      secondPassword: [null, [Validators.required, Validators.maxLength(9),Validators.minLength(20), this.customValidator.specialCharacter, this.customValidator.upperCase, this.customValidator.lowerCase, this.customValidator.oneNumber,Validators.pattern(/^((?!\s{1,}).)*$/)]],
